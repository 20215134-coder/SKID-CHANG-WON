...
import { uploadAssemblyFiles, type AssemblyFileActionState } from "@/features/assembly-files/actions";
...
const initialState: AssemblyFileActionState = {};

export function UploadAssemblyFilesButton({ assemblyId }: { assemblyId: string }) {
  const [open, setOpen] = useState(false);
  const [state, formAction, pending] = useActionState(uploadAssemblyFiles, initialState);
  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>조립품 파일 업로드</DialogTitle>
